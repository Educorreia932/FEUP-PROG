...
class InvalidDate : public Date {
	public:
		InvalidDate() : Date() {}; //default constructor
		InvalidDate(unsigned int year, unsigned int month, unsigned int day) : Date(year, month, day) {};
		InvalidDate(string yearMonthDay) : Date(yearMonthDay) {};
};